            ...
            case 1:
                ...
                try {
                    ...
                    if (success) {
                        ...
                        profile = {
                            username: response.assertion.authenticationstatement.subject.nameidentifier,
...
var Strategy = /** @class */ (function (_super) {
    ...
    Strategy.prototype.service = function (req) {
        var _a;
        var defaultServerBaseUrl = req.protocol + "://" + req.hostname;
        var serviceURL = this.callbackURL || req.originalUrl;
        var resolvedURL = url_1.default.resolve((_a = this.serverBaseURL) !== null && _a !== void 0 ? _a : defaultServerBaseUrl, serviceURL);
